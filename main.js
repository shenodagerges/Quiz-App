...
function createBullets(num) {
    ...
    // Create Bullte
        ...
        // Append Child To Main Bullet Container
...
function addQuestionData(obj, count) {
    ...
    for (i = 1; i <= 4; i++){
        ...
        // Make First Option Selceted
        if (i === 1) {
            radioInput.checked = true;
        }

        // Add Name + Id + Data-Attribute 
...
function showResult(count) {
    ...
    if (currentIndex === count) {
        ...
        if (rightAnswer > count / 2 && rightAnswer < count) {
            ...
            theResults = `<span class="perfect">Perfect</span>, All Answer Is So Perfect`;
        } else {
        ...
        resultsContainer.style.bacgroundColor = "white";
